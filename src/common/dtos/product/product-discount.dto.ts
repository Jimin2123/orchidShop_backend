...
import { IsUUID, IsEnum, IsNumber, IsBoolean, IsDate, IsOptional } from 'class-validator';
...
export class ProductDiscountDTO {
  @ApiProperty({ description: 'Discount ID', example: '123e4567-e89b-12d3-a456-426614174000' })
  @IsUUID()
  id: string;
